...
const LoginPage = () => {
    ...
    return (
        <div className='bg-gray-200'>
            <div className='w-10/12 md:w-8/12  mx-auto my-20 md:grid md:grid-cols-2 '>
                ...
                <div className='hidden md:block group overflow-hidden relative rounded-l-xl shadow-md'>
                    ...
                    <div className='text-white absolute bottom-5 left-5'>
                        ...
                        <p className="opacity-80 text-sm">Join the elite fleet of drivers who demand <br />reliability and luxury in every mile.</p>
                    </div>
                </div>
                ...
                <div className='bg-white p-5 rounded-xl md:rounded-r-xl md:rounded-l-none shadow-md border'>
                    <div className='mb-5 text-center md:text-left'>
                        <h2 className='text-3xl font-bold mb-1.5'>Welcome Back</h2>
                        <p className='text-[#11111180]'>Login in to manage your fleet and bookings.</p>
                    </div>
                    ...
                    <p className='text-[#11111180] text-center my-3'>Do not have an account? <span><Link href={'/register'} className='text-blue-700 font-bold'>Register</Link></span> </p>
                </div>
            </div>
        </div>
    );
